...
@Table(name = "clientes")
public class Clientes implements Serializable,Entidade {
    ...
    public String toString() {
        return "Clientes{" + "id=" + id + ", usuario=" + usuario + ", nome=" + nome + ", tipoDocto=" + tipoDocto + ", documento=" + documento + ", endereco=" + endereco + ", telefone=" + telefone + ", email=" + email + ", descricao=" + descricao + '}';
    }
